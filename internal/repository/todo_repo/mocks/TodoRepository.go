...
// AddNotifications provides a mock function with given fields: _a0
func (_m *TodoRepository) AddNotifications(_a0 []todo.Task) error {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for AddNotifications")
	}
